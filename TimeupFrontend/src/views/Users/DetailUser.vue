        ...
        <div class="bg-white w-[1000px] h-[500px] mt-[200px] m-auto rounded-xl">
            ...
            <div class="w-full h-[400px] rounded-b-xl">
                <div class="grid grid-rows-6 grid-cols-12 content-center justify-items-center">
                    ...
                    <div class="grid row-start-4 col-start-2 col-end-5 content-center text-center text-[18px]">
                        {{ user.nameUser }}
                        <!-- {{user}} -->
                    </div>
                    <div class="grid row-start-5 col-start-2 col-end-5 text-center text-[30px] uppercase">
                        {{ user.roleUser }}
                    </div>
                    <div class="grid row-start-2 col-start-6 col-end-8 content-center text-center text-[18px] ">
                        Email :
                    </div>
                    <div class="grid row-start-2 col-start-8 col-end-12 content-center text-center text-[18px] ">
                        {{ user.emailUser }}
                    </div>
                    <div class="grid row-start-3 col-start-6 col-end-8 content-center text-center text-[18px] ">
                        createOn :
                    </div>
                    <div class="grid row-start-3 col-start-8 col-end-12 content-center text-center text-[18px] ">
                    ...
                    <div class="grid row-start-4 col-start-8 col-end-12 content-center text-center text-[18px] ">
                        {{ moment(user.createOn).local().format("DD/MM/YYYY") }} | {{ moment(user.updateOn).local().format('hh:mm A') }}
