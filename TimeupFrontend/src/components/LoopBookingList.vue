...
<template>
  <div>
    <div>
      ...
      <div
        v-if="bookings == ''"
        class="flex flex-warp justify-center bg-emerald-800 text-white text-xl"
      >
        No scheduled Events
      </div>
      ...
      <div v-else class="grid grid-flow-row grid-cols-3">
        <div
          ...
          :key="index"
          :style="getBg(booking.eventCategoryName)"
          class="mx-24 my-10 border-8 border-[#6D6D6D] rounded-lg text-xl p-5"
        >

          <div class="grid grid-flow-row grid-cols-8 flex p-1">
            <div
              class="row-start-1 col-start-1 col-end-3 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg -mr-12"
            >
              Date
            </div>
            ...
            <div
              class="row-start-1 col-start-3 col-end-9 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg ml-16"
            >
              {{
                moment
                  .utc(moment.utc(booking.eventStartTime).format())
                  .local()
                  .format("DD MMMM YYYY")
              }}
            ...
            <div
              class="row-start-2 col-start-1 col-end-3 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg -mr-12"
            >
              StartTime
            </div>
            ...
            <div
              class="row-start-2 col-start-3 col-end-9 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg ml-16"
            >
              {{
                moment
                  .utc(moment.utc(booking.eventStartTime).format())
            ...
            <div
              class="row-start-3 col-start-1 col-end-3 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg -mr-12"
            >
              Duration
            </div>
            <div
              class="row-start-3 col-start-3 col-end-9 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg ml-16"
            >
              {{ booking.eventDuration }} minute
            </div>

            <div
              class="row-start-4 col-start-1 col-end-3 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg -mr-12"
            >
              CategoryName
            </div>
            <div
              class="row-start-4 col-start-3 col-end-9 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg ml-16"
            >
              {{ booking.eventCategoryName }}
            </div>

            <div
              class="row-start-5 col-start-1 col-end-3 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg -mr-12"
            >
              BookingName
            </div>
            <div
              class="row-start-5 col-start-3 col-end-9 p-1 mb-1.5 bg-[#E2DDDD] rounded-lg ml-16"
            >
              {{ booking.bookingName }}
            </div>
            ...
            <button
              class="row-start-6 col-start-1 col-end-9 mt-5  text-white p-3 rounded-lg"  :style="getSeeMoreDetail(booking.eventCategoryName)"
              @click="changeSeeDetailsDialog(booking)"
            >
              See Details
            </button>
            ...
            <DialogDetails
              v-if="booking.statusClickSeeDetails"
              @onCloseDetails="changeSeeDetailsDialog(booking)"
              :bookings="booking"
